...
String jobName = "orka-it-long-job";
...
<project>
  <actions/>
  <description>This is Jenkins integration tests long job used for testing RunOnce retention strategy</description>
  ...
  <builders>
    <hudson.tasks.Shell>
      <command>echo &apos;Jenkins Integration Test - Run Once&apos;
echo &apos;Sleep for 30 sec&apos;
sleep 30
echo &apos;Sleep ended&apos;</command>
